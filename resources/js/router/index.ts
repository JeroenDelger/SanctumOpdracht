...
import { userRoutes } from "../domains/userAuth/router";
...
export const goToCreatePage = (moduleName: string) => goToRoute(moduleName);
/** Go to the overview page for the given module name */
export const goToOverviewPage = (moduleName: string) => goToRoute(moduleName);
